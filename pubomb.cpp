...
PUBOMB::PUBOMB(WORLD& world_a,int x_a,int y_a,int xvel_a,int yvel_a)
  ...
  for(int index=0;index<posHistory.size();index++)
    {
	  ...
	  glBegin(GL_TRIANGLES);
	  	  //main body
	  glColor4f(0.8f,0.0f,0.0f,alpha);//FF00FF
    ...
    glColor4f(1.0f,0.2f,0.2f,alpha);//FF00FF
	  glVertex3f(-4.0f,4.0f,0.0f);
